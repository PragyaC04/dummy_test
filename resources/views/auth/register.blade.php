                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group{{ $errors->has('pincode') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="pin" type="tel" class="form-control" name="pin" value="{{ old('pin') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('dte') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="dte" type="text" class="form-control" name="dte" required>
